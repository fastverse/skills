...
- **scientific-graphics-r** — experimental. Publication-quality figures with `ggplot2` and `tmap` in a consistent scientific theme, using `collapse` for data preparation.
